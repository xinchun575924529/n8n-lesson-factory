// lesson-04 site router: 先从相对路径取 md，失败回退 GitHub raw
const RAW = 'https://raw.githubusercontent.com/xinchun575924529/n8n-lesson-04-youtube-shorts-generator/main/';
const docs = [
  ['课程主页',      'README.md'],
  ['约定 LEGEND',   'LEGEND.md'],
  ['00 总览',       'docs/00-overview.md'],
  ['01 产稿配音链', 'docs/01-intake.md'],
  ['02 付费墙替身', 'docs/02-paywall-substitutes.md'],
  ['03 合成防线',   'docs/03-synthesis-guard.md'],
...
async function show(i) {
  ...
  try {
    ...
    document.title = docs[i][0] + ' · n8n 教案04';
